    ...
    <div className="terms">
      <ul>
        ...
        <li>
          ...
          <span> View full list of available mutual funds on Cowrywise.</span>
        </li>
        <li>
        ...
        <li>
          ...
          accept our <span>Terms of Use</span> and <span>Privacy Policy.</span>
        </li>
        <li>
        ...
        <li>©2023 Cowrywise Financial Technology. All rights reserved</li>
      </ul>
    </div>
  );
};
